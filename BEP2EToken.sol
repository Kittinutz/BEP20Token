...
contract BEP2EToken is Context, IBEP2E, Ownable {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "BEP2E: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "BEP2E: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].sub(
            amount,
            "BEP2E: transfer amount exceeds balance"
        );
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(
            amount,
            "BEP2E: burn amount exceeds balance"
        );
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][_msgSender()].sub(
                amount,
                "BEP2E: burn amount exceeds allowance"
            )
        );
    }
}
